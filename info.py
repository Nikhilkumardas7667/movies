...
API_ID = int(environ.get('API_ID', '26624379'))
API_HASH = environ.get('API_HASH', '417e257e36a966992e2cc7ca5737d6d2')
BOT_TOKEN = environ.get('BOT_TOKEN', '7944320994:AAFEdzSxJPs6XncWU-ytRVB_R4Uxf8z1-30')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NikhilBot:Nikhilbot@nikhilnewbot.kx2gw.mongodb.net/?retryWrites=true&w=majority&appName=nikhilnewbot")
DATABASE_NAME = environ.get('DATABASE_NAME', "Nikhilbot")
